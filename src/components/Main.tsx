  ...
  return (
    <div id='home' className='w-full h-screen text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex flex-col justify-center items-center'>
        ...
        <p className='bg-white text-sm tracking-widest pt-2 md:pt-4 text-gray-600'>
          I'm a Software Engineer
        </p>
        <div className='bg-white flex items-center justify-between max-w-[330px] pt-4'>
          <div className='p-4 md:p-6 cursor-pointer text-xl text-gray-500 hover:text-teal-500 hover:scale-110 ease-in duration-300'>
            <FaLinkedinIn />
          </div>
          <div className='p-4 md:p-6 cursor-pointer text-gray-500 text-xl hover:text-teal-500 hover:scale-110 ease-in duration-300'>
            <VscGithub />
          </div>
          <div className='p-4 md:p-6 cursor-pointer text-gray-500 text-xl hover:text-teal-500 hover:scale-110 ease-in duration-300'>
            <AiOutlineWhatsApp />
