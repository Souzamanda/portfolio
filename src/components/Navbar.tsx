      ...
      <div>
              ...
              <ul className='flex flex-col gap-8'>
                <Link href='/'>
                  <li
                    ...
                    className='text-3xl text-gray-400 font-bold hover:text-purple-500 dark:text-gray-100 dark:hover:text-yellow-500 ease-in duration-300'>
                    <HiOutlineHome />
                  </li>
                </Link>
        ...
        <div
          ...
          <div className=' flex justify-between items-center p-10  md:pt-0 md:hidden'>
            ...
            <div
              onClick={handleNav}
              className='block cursor-pointer text-gray-900 font-bold hover:text-purple-500 ease-in duration-300 dark:text-gray-100 dark:hover:text-yellow-500'>
              <BsGrid size={20} />
            </div>
            ...
            <div
              ...
              <div
                onClick={handleNav}
                className='p-10 cursor-pointer text-gray-900 font-bold hover:text-purple-500 ease-in duration-300 dark:text-gray-100 dark:hover:text-yellow-500 flex justify-between'>
                  ...
                  <div className='flex flex-col justify-center items-center'>
                    <Link href='/' onClick={handleNav}>
                      <li
                        ...
                        className='text-2xl text-gray-900 font-bold hover:text-purple-500 ease-in duration-300 focus:text-teal-500 dark:text-gray-100 dark:hover:text-yellow-500'>
                        <HiOutlineHome />
                      </li>
                    </Link>
                  ...
                  <div className='flex flex-col justify-center items-center'>
                    <Link href='/#projects' onClick={handleNav}>
                      <li
                        ...
                        className='text-2xl text-gray-900 font-bold hover:text-purple-500 ease-in duration-300 dark:text-gray-100 dark:hover:text-yellow-500'>
                        <BsFiles />
                      </li>
                    </Link>
                    <p className='text-sm p-2 text-gray-600 dark:text-gray-200'>
